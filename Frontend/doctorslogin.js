...
async function web3_metamask_login() {
  ...
  if (web3_check_metamask()) {
    ...
    try {
      ...
      const doctorAddress = '0x70997970C51812dc3A010C7d01b50e0d17dc79C8'; // Replace with your admin account address

      // Check if the logged-in user is the admin
      if (userAddress.toLowerCase() === doctorAddress.toLowerCase()) {
